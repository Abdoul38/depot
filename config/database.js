...
async function initializeDatabase() {
  try {
    ...
    // Créer la table transactions_paiement
    await pool.query(`
    ...
    // Créer la table paiement_temporaire
    await pool.query(`
    ...
    // Créer la table config_inscription
    await pool.query(`
    ...
    // Créer la table restriction_inscription
    await pool.query(`
    ...
    await pool.query(`
      ...
      CREATE INDEX IF NOT EXISTS idx_etudiant_numero_dossier ON etudiant(numero_dossier);
      CREATE INDEX IF NOT EXISTS idx_inscription_etudiant ON inscription(etudiant_id);
      CREATE INDEX IF NOT EXISTS idx_inscription_annee ON inscription(annee_universitaire);
      CREATE INDEX IF NOT EXISTS idx_inscription_statut ON inscription(statut_inscription);
      CREATE INDEX IF NOT EXISTS idx_restriction_type ON restriction_inscription(type);
      CREATE INDEX IF NOT EXISTS idx_restriction_actif ON restriction_inscription(actif);
      CREATE INDEX IF NOT EXISTS idx_config_annee ON config_inscription(annee_universitaire);
      CREATE INDEX IF NOT EXISTS idx_config_actif ON config_inscription(actif);
      CREATE INDEX IF NOT EXISTS idx_paiement_temp_etudiant ON paiement_temporaire(etudiant_id);
      CREATE INDEX IF NOT EXISTS idx_paiement_temp_transaction ON paiement_temporaire(transaction_id);
      CREATE INDEX IF NOT EXISTS idx_transaction_inscription ON transactions_paiement(inscription_id);
      CREATE INDEX IF NOT EXISTS idx_transaction_id ON transactions_paiement(transaction_id);
      CREATE INDEX IF NOT EXISTS idx_transaction_statut ON transactions_paiement(statut);
    `);
